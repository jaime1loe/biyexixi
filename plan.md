...
overview: 构建一个本科毕业设计级别的智能答疑系统，使用Vue+SpringBoot+Python技术栈，整合开源大模型（ChatGLM/Qwen）实现智能问答，核心功能包括RAG知识库问答、启发式学习引导、个性化推荐等。
design:
  styleKeywords:
    - 简洁
    - 现代
...
todos:
  - id: setup-backend
    content: 创建SpringBoot后端项目，配置MySQL数据库连接
    status: pending
  - id: setup-frontend
    content: 创建Vue3前端项目，集成Element Plus组件库
    status: pending
  - id: setup-ai-env
    content: 搭建Python AI服务环境，安装LangChain等依赖
    status: pending
  - id: deploy-llm
...
- 前端：Vue3单页应用
- 后端：SpringBoot提供API服务
- AI服务：Python Flask/FastAPI提供智能问答接口
...
- [ ] 1. 创建SpringBoot后端项目，配置MySQL数据库连接
- [ ] 2. 创建Vue3前端项目，集成Element Plus组件库
- [ ] 3. 搭建Python AI服务环境，安装LangChain等依赖
- [ ] 4. 部署开源大模型（ChatGLM或Qwen）
- [ ] 5. 实现用户登录注册功能
- [ ] 6. 开发智能问答前端界面
- [ ] 7. 开发智能问答后端API
- [ ] 8. 实现RAG问答引擎（向量化+检索+生成）
- [ ] 9. 开发知识库管理功能（文档上传、向量化存储）
- [ ] 10. 构建模拟高校知识库数据（50-100条QA）
- [ ] 11. 实现问答历史记录功能
- [ ] 12. 开发问答评价反馈功能
- [ ] 13. 实现基础数据统计看板
- [ ] 14. 系统测试与性能优化
...
| 任务ID         | 任务内容                                    | 优先级 |
| -------------- | ------------------------------------------- | ------ |
| setup-backend  | 创建SpringBoot后端项目，配置MySQL数据库连接 | 高     |
...
| 成员       | 技术栈                    | 主要职责                           | 工作占比 |
| ---------- | ------------------------- | ---------------------------------- | -------- |
| **李佳敏** | Java + SpringBoot + MySQL | 后端API开发、数据库设计            | ~33%     |
